...
class HomePage:
    ...
    def __init__(self, screen_width: int, screen_height: int, ui_manager, game_manager, nav_bar_height: int = 100):
        ...
        #     home_page.handle_mouse_motion(event.pos)

        # # ✅ 鼠标点击处理精灵动画
        # if event.type == pygame.MOUSEBUTTONDOWN:
        #     click_result = home_page.handle_mouse_click(event.pos)
        #     if click_result == "sprite":
        #         print("✅ 点击了精灵，已触发动画")
    ...
    def create_layout(self):
        ...
        # 精灵区域 - 加大一倍，向左移动
        sprite_size = scaled(250)  # 放大一倍
        sprite_margin_x = scaled(100)  # 向左移动一些
        sprite_margin_y = scaled(100)
